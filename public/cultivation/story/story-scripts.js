...
export const STORY_CHAPTERS = Object.freeze([
  ...
  Object.freeze({
    ...
    lines: Object.freeze([
      c('narrator', '煉氣五層那日，你照常在問道碑前答題。碑上的悟念沒有落回石中，反而化成一縷紫光，沿著仙府的地磚向深處游去。'),
      c('player', '師姐，碑是不是漏了？', 'confused'),
      c('shen', '是你終於能打開另一扇門了。'),
      c('player', '又要答更難的題？', 'confused'),
      c('shen', '這次換你整理知識，替自己造一場試煉。'),
      c('narrator', '沈清霜抬手，仙府一角的空間向內折疊，一道紫色門扉慢慢展開。門後有山影與水聲，卻只有巴掌大小。'),
      c('shen', '這叫洞天。課文、筆記和圖片，都能煉成固定題序的知識秘境。'),
      c('player', '把課本塞進去，就不用讀書了？', 'happy'),
      c('shen', '它會把你沒讀懂的地方，變成題目來問你。'),
      c('player', '……原來是課本反過來找我算帳。', 'confused'),
      c('narrator', '沈清霜取出一枚淡紫玉簡。簡上只有一道試煉，與真正的洞天相比小得可憐，卻連同入口、作答與結算都準備齊全。'),
      c('shen', '這是私人範例，只需一題。去洞府親手進入，答完看解析，再回到名冊把它刪掉。我在這裡等你。'),
      c('narrator', '你重新回到紫色門扉前，玉簡化作微光。沈清霜仍站在原地，彷彿這段時間只夠她眨一次眼。'),
      c('player', '師姐，原來一題也能走完一座洞天。', 'happy'),
      c('shen', '一題是教你用法，不是正式洞天的規矩。正式建立時，至少十題，還要先理清教材的重點。'),
      c('player', '所以洞天不是幫我省掉理解，而是逼我知道自己漏掉什麼。', 'determined'),
      c('shen', '答對一題，只代表這題你會。能說出為什麼、看出題目哪裡有錯，才算真正問道。'),
      c('narrator', '正說著，紫色門扉深處掠過一道極細的墨色紋路。它與問道碑上的古紋不同，只一閃便消失。'),
      c('player', '剛才那道黑影，也是洞天的一部分？', 'confused'),
      c('shen', '不是。往後若遇到來歷不明的黑色符紋，不要碰，先告訴我。'),
      c('player', '師姐，妳是不是知道些什麼？', 'confused'),
      c('shen', '現在先把你自己的題目看明白。別人的麻煩，等你有本事再問。'),
      c('narrator', '她轉身離去，紫色門扉在你身後安靜地合攏。你記住了洞天的用法，也記住了那道不該出現在這裡的黑紋。')
    ])
  }),
    ...
    lines: Object.freeze([
      ...
      c('player', '所以第一場是我跟顧長風？', 'confused'),
      c('rival', '我沒意見。'),
      c('shen', '不。'),
      c('player', '那是誰？', 'confused'),
      c('shen', '我。'),
      c('player', '……師姐親自？', 'confused'),
      c('rival', '我建議你先確認鬥法臺的保命陣法有沒有開。'),
      c('shen', '開了。這裡用靈識投影演武，投影敗北不會真的死亡。'),
      c('player', '那就好。', 'happy'),
      c('shen', '痛覺也關了。'),
      c('player', '師姐突然很體貼。', 'happy'),
      c('shen', '因為你等一下沒空想這個。'),
