...
import { ARTIFACT_CATALOG, ARTIFACT_REALMS, getArtifactById, realmForScore, realmOrderByName } from './artifact-catalog.js';
...
(function () {
  ...
  function forgeItemMarkup(item) {
    ...
    return `<article class="artifact-item ${eqSlot ? 'is-equipped' : ''}">
