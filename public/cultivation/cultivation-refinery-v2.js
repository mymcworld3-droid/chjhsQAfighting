...
(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      @media(max-width:900px){.cultivation-refinery{grid-template-columns:1fr}.refinery-material-list{height:min(52dvh,300px);max-height:300px}.refinery-slots{--array-size:min(62vw,410px)}}
  ...
  function markup() {
    ...
    const ingredientHtml = `<section class="refinery-material-roll" data-refinery-material-roll="materials"><div class="refinery-group-title"><span>一般素材</span><span>${ownedMaterials.length} 種</span></div><div class="refinery-material-roll-body" data-refinery-material-roll-body="materials">${materialHtml || '<div class="refinery-empty">目前沒有一般素材。</div>'}</div></section><section class="refinery-material-roll" data-refinery-material-roll="artifacts"><div class="refinery-group-title"><span>二次煉製</span><span>${ownedArtifacts.length} 種 · 最多 2 層</span></div><div class="refinery-material-roll-body" data-refinery-material-roll-body="artifacts">${artifactHtml || '<div class="refinery-empty">目前沒有可投入的法寶；已裝備法寶會保留。</div>'}</div></section>`;
