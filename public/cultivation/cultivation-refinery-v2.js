...
(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      .refinery-material-list{display:grid;grid-template-columns:repeat(auto-fill,minmax(96px,1fr));grid-auto-rows:max-content;align-content:start;gap:8px;max-height:430px;overflow:auto;padding:2px 4px 4px 1px}.refinery-material{position:relative;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:5px;width:100%;aspect-ratio:1;min-width:0;padding:9px 7px;border:1px solid rgba(255,255,255,.065);border-radius:14px;background:radial-gradient(circle at 50% 28%,rgba(216,177,93,.055),rgba(255,255,255,.014));text-align:center;overflow:hidden}.refinery-material:not(:disabled):hover{border-color:rgba(216,177,93,.36);background:radial-gradient(circle at 50% 28%,rgba(216,177,93,.10),rgba(216,177,93,.025));transform:translateY(-1px)}.refinery-material:disabled{opacity:.4;cursor:not-allowed}.refinery-mat-icon{width:42px;height:42px;flex:0 0 42px;display:grid;place-items:center;border:1px solid rgba(216,177,93,.25);border-radius:12px;background:#171006;color:#efd17c;font-size:12px;font-weight:900}.refinery-mat-copy{display:flex;min-width:0;width:100%;flex-direction:column;align-items:center;gap:2px}.refinery-mat-copy strong{display:block;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#ede1c8;font-size:9px}.refinery-mat-copy small{display:block;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#81745f;font-size:6px}.refinery-mat-copy .material-realm-badge{margin-top:1px!important}.refinery-mat-qty{position:absolute;right:6px;top:6px;padding:2px 5px;border-radius:999px;background:rgba(0,0,0,.48);color:#d5b96e;font-size:6px;font-weight:900;white-space:nowrap}.refinery-empty{grid-column:1/-1;padding:22px 12px;text-align:center;color:#82745f;font-size:9px;border:1px dashed rgba(216,177,93,.13);border-radius:13px;line-height:1.7}
      ...
      @media(max-width:430px){.refinery-material-list{grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.refinery-slots{gap:5px}.refinery-slot{min-height:55px;border-radius:10px}.refinery-material{padding:7px 5px}.refinery-mat-icon{width:36px;height:36px;flex-basis:36px}.refinery-mat-copy strong{font-size:7px}.refinery-mat-copy small{font-size:5.5px}}
    `;
