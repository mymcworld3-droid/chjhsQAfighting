...
(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      .refinery-key-requirement{position:relative;z-index:3;display:grid;grid-template-columns:40px minmax(0,1fr) auto;gap:9px;align-items:center;margin:0 0 8px;padding:8px 10px;border:1px solid rgba(216,177,93,.22);border-radius:12px;background:linear-gradient(135deg,rgba(216,177,93,.07),rgba(0,0,0,.18));color:#d8c08a}.refinery-key-requirement.is-hidden{display:none}.refinery-key-requirement.is-ready{border-color:rgba(108,210,145,.28);background:rgba(55,116,77,.08)}.refinery-key-requirement.is-missing{border-color:rgba(248,113,113,.32);background:rgba(130,38,38,.09)}.refinery-key-requirement.is-consumed{border-color:rgba(143,215,210,.24);background:rgba(42,92,94,.08)}.refinery-key-icon{width:38px;height:38px;display:grid;place-items:center;overflow:hidden;border:1px solid rgba(236,201,118,.34);border-radius:11px;background:radial-gradient(circle at 32% 25%,rgba(255,255,255,.14),rgba(83,55,20,.3) 45%,#0b0a08);color:#e8ca82;font-size:9px;font-weight:900}.refinery-key-icon img{width:100%;height:100%;object-fit:cover}.refinery-key-copy{min-width:0;display:grid;gap:1px}.refinery-key-copy small{color:#968263;font-size:6px;letter-spacing:.08em}.refinery-key-copy strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:#f0dfb5;font-size:10px}.refinery-key-copy em{color:#a89473;font-size:7px;font-style:normal}.refinery-key-requirement.is-missing .refinery-key-copy em{color:#e7a09a}.refinery-key-requirement>b{color:#e7c779;font-size:12px}.refinery-recipe-key{display:grid;grid-template-columns:22px minmax(0,1fr) auto;gap:8px;align-items:center;margin:8px 12px;padding:8px 9px;border:1px solid rgba(216,177,93,.18);border-radius:10px;background:rgba(216,177,93,.035)}.refinery-recipe-key.is-ready{border-color:rgba(108,210,145,.22)}.refinery-recipe-key.is-missing{border-color:rgba(248,113,113,.27)}.refinery-recipe-key>i{color:#d7b660}.refinery-recipe-key span{display:grid;gap:1px}.refinery-recipe-key b{color:#e9d8b0;font-size:8px}.refinery-recipe-key small{color:#8e8069;font-size:7px}.refinery-recipe-key>strong{color:#e4c474;font-size:9px}
