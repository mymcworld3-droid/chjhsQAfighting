...
(function () {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      .refinery-panel{min-width:0;padding:14px;border:1px solid rgba(216,177,93,.2);border-radius:20px;background:linear-gradient(145deg,rgba(21,17,10,.97),rgba(7,7,7,.985));box-shadow:0 16px 42px rgba(0,0,0,.34);position:relative;overflow:hidden}.refinery-material-panel{padding:0;display:grid;grid-template-rows:minmax(0,1fr);overflow:hidden}
      ...
      @media(max-width:900px){.cultivation-refinery{grid-template-columns:1fr}.refinery-material-panel{height:min(52dvh,360px)}.refinery-material-list{height:100%;max-height:none}.refinery-slots{--array-size:min(62vw,410px)}}
